...
our $SCHEMA = [
    ...
    {begin_cat => ['Advanced Settings', 'gnome-settings']},
        ...
        {item => ["~/scripts/dual_monitor.sh",                                              'Auto Configure Monitor(s)',      'shellscript']},
        {item => ["xfce4-terminal -e '/home/nsm09/scripts/pawrap.sh SET_ACTIVE'",           'Set Default Audio Output',    'shellscript']},
